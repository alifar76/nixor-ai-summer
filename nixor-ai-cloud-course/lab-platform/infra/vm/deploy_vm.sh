...
# Deployment that backs the in-app coding chatbot (the platform tutor) — gpt-5.3.
AZURE_OPENAI_DEPLOYMENT="${AZURE_OPENAI_DEPLOYMENT:-oai-gpt53}"
AZURE_OPENAI_API_VERSION="${AZURE_OPENAI_API_VERSION:-2024-10-21}"
CHAT_DEFAULT_MODEL_ID="${CHAT_DEFAULT_MODEL_ID:-gpt-5.3}"
AZURE_FOUNDRY_ENDPOINT="${AZURE_FOUNDRY_ENDPOINT:-}"
AZURE_FOUNDRY_API_KEY="${AZURE_FOUNDRY_API_KEY:-}"
# The 4 deployable catalog models students use in their own apps.
MODEL_GPT53_DEPLOYMENT="${MODEL_GPT53_DEPLOYMENT:-oai-gpt53}"
...
AZURE_FOUNDRY_ENDPOINT=$AZURE_FOUNDRY_ENDPOINT
AZURE_FOUNDRY_API_KEY=$AZURE_FOUNDRY_API_KEY
MODEL_GPT53_DEPLOYMENT=$MODEL_GPT53_DEPLOYMENT
