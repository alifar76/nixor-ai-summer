...
(gpt-5.3 via deployment `oai-gpt53` by default) running on Microsoft Azure. Over the
...
# ---------------------------------------------------------------------------
APP_TITLE = "My AI App"  # 👈 EDIT THIS — what's your app called?

SYSTEM_PROMPT = (  # 👈 EDIT THIS — this is the AI's job description. Be specific!
    "You are a friendly, encouraging study buddy for A-level students. "
